...
public class UBERStudent20170953 {
	...
	public static void main(String[] args) throws Exception {
		...
		if(args.length < 1) {
            System.out.println("Usage : UBERStudent20170953 <input> <output>");
            System.exit(1);
		}

		SparkSession spark = SparkSession
            .builder()
            .appName("UBERStudent20170953")
            .getOrCreate();
		// read file
		JavaRDD<String> lines = spark.read().textFile(args[0]).javaRDD();
		
		JavaPairRDD<String, String> pTuples = lines.mapToPair(new PairFunction<String, String, String>() {
    		public Tuple2<String, String> call(String s) {
    			tring [] splited = s.split(",");
				...
				String dayOfWeek = parseToString(dayNum);
		...
		JavaPairRDD<String, String> counts = pTuples.reduceByKey(new Function2<String, String, String>() {
